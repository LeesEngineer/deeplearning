...
![158f97eb-02c2-443c-9084-c75a4a2a80be](https://github.com/user-attachments/assets/01e7e8bc-04e8-4abd-a268-f35538f7ef99)

<p>如果把 g[1](z[1]) 和 g[2](z[2]) 同时设置成线性激活函数（恒等激活函数），那么神经网络的输出仅仅是输入特征的线性变化</p>

<p>深度网络有许多许多层，但如果没有使用使用激活函数，那么无论神经网络有多少层，他所做的只是计算一个线性激活函数（这还不如去除所有隐藏层）</p>、

<p>只有一个地方可以使用线性激活函数----将机器学习用于回归问题，即y 是一个实数（预测房价），而且还是在输出层，在隐藏层应该用 ReLU, tanh, Leaky-ReLU</p>
